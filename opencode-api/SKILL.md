...
# 发送 review 消息（自动使用 reviewModel）
python main.py --session-id 1776356413363 send-review '审查代码变更'
...
| `send-review` | 发送 review 消息，自动使用 reviewModel 配置（modelID/providerID） | 必填：消息内容 |
